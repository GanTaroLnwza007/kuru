...
**Acceptance criteria:**
- [x] Frontend workspace boots with Next.js App Router and TypeScript.
- [x] Script set includes dev/build/start/lint/typecheck/test.
**Blocked by:** None
...
**Acceptance criteria:**
- [x] Strict mode and no-implicit-any style checks are active.
- [x] Path aliases are defined and used consistently.
**Blocked by:** TASK-001
...
**Acceptance criteria:**
- [x] Runtime config supports App Router defaults without pages directory usage.
- [x] Config allows environment-driven API base usage pattern.
**Blocked by:** TASK-001
...
**Acceptance criteria:**
- [x] Template includes NEXT_PUBLIC_API_BASE_URL.
- [x] No secrets or private keys are included.
**Blocked by:** TASK-001
...
**Acceptance criteria:**
- [x] Missing required env vars fail at startup with clear error messages.
- [x] API base URL is exported in typed form for app-wide usage.
**Blocked by:** TASK-004
...
**Acceptance criteria:**
- [x] Tailwind scans all app/components/lib directories.
- [x] Theme extension includes reusable semantic tokens for KUru UI.
**Blocked by:** TASK-001
...
**Acceptance criteria:**
- [x] Global token variables exist for primary, secondary, surface, text, and status colors.
- [x] Navbar tokens exist for header height, translucent background, blur strength, and shadow.
- [x] Base styles support readable typography and touch-friendly spacing on 375px width.
**Blocked by:** TASK-006
...
**Acceptance criteria:**
- [x] Layout defaults to Thai-first user experience with bilingual readiness.
- [x] Root structure supports shared header/navigation and provider mounting.
**Blocked by:** TASK-007
...
**Acceptance criteria:**
- [x] Component generation paths match frontend folder architecture.
- [x] Tailwind and alias settings align with existing config.
**Blocked by:** TASK-006
...
**Acceptance criteria:**
- [x] Utility handles conditional class merging.
- [x] Utility is imported by at least one layout or UI component.
**Blocked by:** TASK-009
...
**Acceptance criteria:**
- [x] Container uses a top header height of 76px.
- [x] Desktop layout supports a centered content region with 1280px max width.
- [x] Mobile behavior remains full-width and touch-friendly.
**Blocked by:** TASK-007
...
**Acceptance criteria:**
- [x] Background is rgba(255, 255, 255, 0.8).
- [x] Shadow is 0px 12px 32px rgba(25, 28, 27, 0.04).
- [x] Backdrop blur uses 6px with fallback behavior when unsupported.
**Blocked by:** TASK-033
...
**Acceptance criteria:**
- [x] App shell renders TopNavBar consistently across route groups.
- [x] Header area preserves desktop and mobile spacing without duplicated layout logic.
...
**Acceptance criteria:**
- [x] Navigation exposes all MVP entry points: Chat, Explore, RIASEC, and Portfolio.
- [x] Desktop presents left/center/right grouping consistent with the design.
- [x] Active item state includes a clear underline indicator.
- [x] Mobile keeps utility actions accessible and supports menu-first navigation behavior.
**Blocked by:** TASK-011
...
**Acceptance criteria:**
- [x] Locale config includes Thai default and English fallback.
- [x] Routing config is reusable by middleware and i18n requests.
**Blocked by:** TASK-001
...
**Acceptance criteria:**
- [x] Locale message files are loaded based on active locale.
- [x] Missing locale falls back safely without runtime crash.
**Blocked by:** TASK-013
...
**Acceptance criteria:**
- [x] Default locale behavior is deterministic and Thai-first.
- [x] Middleware does not interfere with API route handling.
**Blocked by:** TASK-013
...
**Acceptance criteria:**
- [x] Core shell and feature-entry labels are present in Thai.
- [x] Tone aligns with student-friendly language guidance.
**Blocked by:** TASK-014
...
**Acceptance criteria:**
- [x] English catalog mirrors Thai key structure.
- [x] Missing keys are tracked and fail gracefully.
**Blocked by:** TASK-014
...
**Acceptance criteria:**
- [x] Types represent KUru response envelope with sources and error.
- [x] Types are imported by API client module.
**Blocked by:** TASK-005
...
**Acceptance criteria:**
- [x] Wrapper reads API base URL from validated env module.
- [x] Wrapper normalizes network and API envelope errors.
**Blocked by:** TASK-018
...
**Acceptance criteria:**
- [x] Store contains isolated slices for chat and RIASEC data.
- [x] Store is type-safe and importable by client components.
**Blocked by:** TASK-002
...
**Acceptance criteria:**
- [x] Providers support async polling flows for long-running analysis jobs.
- [x] Providers can be mounted once at app root.
**Blocked by:** TASK-019
...
**Acceptance criteria:**
- [x] Chat route renders within shared app shell.
- [x] Placeholder UI includes loading and empty-state sections.
**Blocked by:** TASK-012
...
**Acceptance criteria:**
- [x] Explorer route renders search input and result container placeholders.
- [x] Layout supports fast-scanning list behavior for mobile users.
**Blocked by:** TASK-012
...
**Acceptance criteria:**
- [x] Dynamic route resolves programId parameter.
- [x] Placeholder sections exist for detail overview and year-by-year vibe.
**Blocked by:** TASK-023
...
**Acceptance criteria:**
- [x] Route includes clear step-based scaffold structure.
- [x] Shell supports state-driven question rendering in later tasks.
**Blocked by:** TASK-020
...
**Acceptance criteria:**
- [x] Route includes form placeholder and async status region.
- [x] Shell is compatible with polling-based result updates.
**Blocked by:** TASK-021
...
**Acceptance criteria:**
- [x] Test runner executes app/component tests locally.
- [x] Alias resolution works in tests.
**Blocked by:** TASK-002
...
**Acceptance criteria:**
- [x] Setup file is auto-loaded by test runner.
- [x] Shared wrappers are available for route/component smoke tests.
**Blocked by:** TASK-027
...
**Acceptance criteria:**
- [x] Test covers chat, explore, riasec, and portfolio route shells.
- [x] Test suite passes in local CI command path.
...
**Acceptance criteria:**
- [x] Config includes at least one 375px viewport project.
- [x] Config supports local and CI execution.
**Blocked by:** TASK-001
...
**Acceptance criteria:**
- [x] Guide includes first-run instructions and troubleshooting checklist.
- [x] Guide includes branch naming and commit linkage to task IDs.
...
**Acceptance criteria:**
- [x] Generated schemas cover chat, riasec, programs, and portfolio endpoints.
- [x] API client uses generated endpoint types in method signatures.
**Blocked by:** BACKEND-CONTRACT-001 (stable OpenAPI for /api/v1 not yet published)
**Note:** Mitigated by manually creating comprehensive Zod schemas in schemas.generated.ts for all known endpoints. Once backend OpenAPI is published, schemas can be auto-generated to replace manual implementation.
